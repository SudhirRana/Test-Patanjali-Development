												...
												<fo:table-row>
													...
													<fo:table-cell width="20.5cm" padding="1mm">
														<fo:block margin-top="4mm" text-decoration="underline" text-align="left" text-transform="uppercase">
															...
															<fo:inline padding-left="2.7in">Purchase Invoice</fo:inline>
														</fo:block>
															...
															<fo:table>
																<fo:table-body>
																	<fo:table-row>
																		...
																		<fo:table-cell width="5cm" text-align="left"><fo:block>${sendingParty.partyId!}</fo:block></fo:table-cell>
																	</fo:table-row>
																	<fo:table-row>
																		<fo:table-cell text-align="left" width="9cm" padding-top="2mm" padding-bottom="4mm">
																			<fo:block wrap-option="no-wrap">
																				<#if billingAddress??>
																	                <#assign billToPartyNameResult = dispatcher.runSync("getPartyNameForDate", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("partyId", sendingParty.partyId, "compareDate", invoice.invoiceDate, "userLogin", userLogin))/>
						                											...
						                											<#if billingAddress.address2?has_content><fo:block>${billingAddress.address2!}</fo:block></#if>
																					<fo:block>
																	                ...
																	                <fo:block>
																	                    <#assign countryGeo = (delegator.findOne("Geo", {"geoId", billingAddress.countryGeoId!}, false))! />
																	                    <#if countryGeo?has_content>${countryGeo.geoName!}</#if>
																	                </fo:block>
																	            <#else>
																	            	<fo:block>
																			            <fo:inline font-weight="bold">Party Name :</fo:inline> ${Static['org.apache.ofbiz.party.party.PartyHelper'].getPartyName(sendingParty)}
																			        </fo:block>
																	            </#if>
																			</fo:block>
																		</fo:table-cell>
