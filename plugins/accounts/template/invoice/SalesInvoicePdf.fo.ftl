...
<#escape x as x?xml>
	<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" font-family="Verdana, Arial, sans-serif, Ubuntu">
	  <fo:layout-master-set>
	    <fo:simple-page-master master-name="SalesOrderPdf"
	  ...
	  <fo:page-sequence master-reference="SalesOrderPdf">
	    <fo:flow flow-name="xsl-region-body">
	        <fo:block font-size="10pt" >
	          ${screens.render(CompanyHeaderSales)}
	        </fo:block>
    		<fo:block font-size="8pt">
		 	 	${screens.render(InvoiceReportBodySales)}
			</fo:block> 
	 		<fo:block id="theEnd"/>
	    </fo:flow>
	  </fo:page-sequence>
